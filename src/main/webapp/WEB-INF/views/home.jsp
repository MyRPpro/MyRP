            ...
            <div class="col-md-2" id="menu_nav" >
            	<div class="panel-group" id="accordion" role="tablist" aria-multiselectable="true" >
            		...
            		<!-- 사이드 메뉴 시작 ----------------------------------------------------- -->
		                 ...
		                 <div class="panel panel-default" style="border-radius: 0px; box-shadow: 2px 2px 4px DarkGray; "> 
	            ...
	            <div class="col-md-2" id="alrim_center" >
	               <div class="panel panel-warning">
	                  <div class="panel-heading text-center"><span class="glyphicon glyphicon-bell"></span>&nbsp;알림센터</div>
