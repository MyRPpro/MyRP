...
<script type="text/javascript">
	...
	$("#page16620_div01_toggle").bind("click", function(event) {
		$("#page16620_div01").slideToggle();
		return false;
	});
	
	$("#page16620_btn01").bind("click", function(event) {
		$("#page16620").slideUp();
	...
	$("form[name='page16620_form01'] select[name='dept_id']").on("change", function(event) {
		var $dept_id = $("form[name='page16620_form01'] select[name='dept_id']"); 
		$.getJSON("/hr_management/manage_hr_appointment/select_dept/"+$dept_id.val(), function(data) {
			...
			$("form[name='page16620_form01'] select[name='employee_id']").html(str);
		});
		return false;
	});
	
	$("form[name='page16620_form01']").on("submit", function(event) {
		var $dept_id = $("form[name='page16620_form01'] select[name='dept_id']"); 
		var $employee_id = $("form[name='page16620_form01'] select[name='employee_id']"); 
		if($dept_id.val() == 0 || $employee_id.val() == 0) {
			alert("부서와 사원을 선택해 주세요.");
			$dept_id.focus();
			return false;
		}
		$("#page16620_div01").slideUp();
		$("#page16620_div02").load("/hr_management/manage_hr_appointment/hr_appointment_regform"
