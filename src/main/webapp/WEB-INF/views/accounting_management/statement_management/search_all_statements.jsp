		...
		<div class="page_nav">
			<div class="text-center">
					...
					<c:if test="${startPage > pageBlock}">
						<li><a href="/accounting_management/statement_management/search_all_statements">◀◀</a></li> <!-- 첫 페이지로 이동 -->
						<li><a href="/accounting_management/statement_management/search_all_statements?pageNum=${startPage - pageBlock}">◀</a></li>
					</c:if>
					<c:forEach var="i" begin="${startPage}" end="${endPage}">
						...
						<c:if test="${i != currentPage}">
							<li><a href="/accounting_management/statement_management/search_all_statements?pageNum=${i}">${i}</a></li>
						</c:if>
					</c:forEach>
					<c:if test="${pageCount > endPage}">
						<li><a href="/accounting_management/statement_management/search_all_statements?pageNum=${startPage + pageBlock}">▶</a></li> <!-- 다음 블록으로 이동 -->
						<li><a href="/accounting_management/statement_management/search_all_statements?pageNum=${pageCount}">▶▶</a></li> <!-- 마지막 페이지로 이동 -->
					</c:if>
					</ul>
			</div>
		</div>
