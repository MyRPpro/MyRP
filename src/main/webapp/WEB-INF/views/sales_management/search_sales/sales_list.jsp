...
<body>
				...
				<div class="panel-body" id="sales_list_panel_body" >
					<div class="input-group" id="sales_list_input-group" style="width: 100%;">
						<font class="media-heading" style="margin:0 auto;"> 입력된 판매 내역을 검색 할 수 있는 페이지 입니다.</font><br><br>
							<form class="form-inline-block" id="sales_list_form" action="#" name="purchase_list_form" method="get"  onsubmit="return search_list(1)" >
								...
								<div class="btn-group btn-group-justified" role="group" aria-label="...">
									<div class="btn-group" role="group">
										<button type="button" class="btn btn-primary" onclick="return search_list(0)">전체검색</button>
									</div>
									<div class="btn-group" role="group">
										<button type="button" class="btn btn-primary" id="list_btn_reg">판매등록</button>
									</div>
									<div class="btn-group" role="group">
										<button type="button" class="btn btn-default" onclick="return search_list(2)">전표신청</button>
									</div>
									<div class="btn-group" role="group">
										<button type="button" class="btn btn-default" onclick="return search_list(3)">전표승인</button>
									</div>
									
									<div class="btn-group" role="group">
										<button type="button" class="btn btn-default" onclick="return search_list(5)">출고조회</button>
									</div>
									
									
									<div class="btn-group" role="group">
										<button type="button" class="btn btn-default" onclick="return search_list(7)">수금완료</button>
									</div>
	...
	function search_list(check){
		...
		$('#list_table').slideDown(500);
		$('#list_page').load('/sales_management/search_sales/sales_list_page?search_str='+search_str);
		$('#list_table').load('/sales_management/search_sales/sales_list_table?search_str='+search_str);
		return false;
	}
