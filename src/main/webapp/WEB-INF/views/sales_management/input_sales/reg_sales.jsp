...
<body>
	...
	<div class="row">
		<div class="col-xs-12">
			<div class="panel panel-primary">
				<div class="panel-heading" id="reg_sales_heading">
					<h3 class="panel-title">
						<span class="glyphicon glyphicon-euro"></span> &emsp; 
						판매 입력 페이지 Reg_Sales
					</h3>
				</div>	<!--  // panel-heading -->
				<div class="panel-body" id="reg_sales_content" >
					<div class="table-responsive">
						<form action="#" id="reg_table_form" method="get" onsubmit="return reg_sales_detail();">
							<div class="form-group">
								...
								<br>
								<center>
									<input type="submit" class="btn btn-primary" name="btn_submit" value="등록하기" >
	...
	function reg_sales_detail(){
			 ...
			 $('#table_list').load('/sales_management/input_sales/reg_sales_table?product_id='+product_id.value
	...
	$('#reg_sales_heading').click(function(){
		$('#reg_sales_content').slideToggle();
	});
