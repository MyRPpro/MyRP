...
<body>
	...
	<form action="#" name="reg_table_form" method="get" 
		...
		<c:if test="${dto == null}">
		<table border="1" border="1" id="lack_stock_table_new" >
			...
			<tr>
				...
				<td colspan="2"> 
					<input type="hidden" name="purchase_state" id="purchase_state" value="23203">
					<input type="text" name="purchase_state_name" id="purchase_state_name" value="구매전표승인요청" readonly >
				</td>	
			</tr>
