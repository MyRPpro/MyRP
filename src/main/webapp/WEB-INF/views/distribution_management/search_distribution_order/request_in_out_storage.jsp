...
<div class="col-xs-12">
	<div class="panel panel-primary">
		<div class="panel-heading distribution_view_heading">
			<h3 class="panel-title"><a><span class="glyphicon glyphicon glyphicon-road" aria-hidden="true"></span>물류 출고요청</a></h3>
		</div>
...
<div class="col-xs-12">
	<div class="panel panel-primary">
		<div class="panel-heading distribution_view_heading">
			<h3 class="panel-title"><a><span class="glyphicon glyphicon glyphicon-road" aria-hidden="true"></span>물류 입고요청</a></h3>
		</div>
		<div class="panel-body distribution_view_content">
			<div class="table-responsive">
				<table class="table table-condensed">
