...
<body>
	...
	<script type="text/javascript">
		...
		$('#page3130_div01_toggle').click(function(){
			$('#page3130_div01').slideToggle();
			return false;
		});
		...
		function condition_check() {
			var condition = document
					.getElementById("reg_condition_note_payable");
		...
		function check_date() {
			...
			var in_date = new Date(document
					.getElementById("reg_storage_in_date").value);
