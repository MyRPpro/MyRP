...
<body>
			...
			<div class="panel panel-primary">
				<div class="panel-heading">
			  		 <h4 class="panel-title">
			  		 	<a id="page2310_div01_toggle"><span class="glyphicon glyphicon-tags"></span> &nbsp;
			  				<b>판매 현황 검색 페이지 </b>
			  			</a>
			  		</h4>
				</div>
				<div class="panel-body" id="page2310_div01" style="margin-bottom: 0px;">
					...
					<!-- ----------------------------------------------------- -->
					<div class="panel-body" id="page2310_div02" style="padding-bottom: 0px;"></div>
				</div>	<!-- // panel-body -->
				<div class="panel-body" id="page2310_div03"></div>
			</div>	<!-- // panel -->
		</div>
	</div>
	<!-- ------------------------------------------------------------------------------------- -->
	...
	$('#page2310_div01_toggle').click(function(){
		$('#page2310_div01').slideToggle();
		return false;
	});
	...
	function list_table(param,check){
		...
		$('#page2310_div03').load('/sales_management/status_sales/search_status_sales_table?start_date='+start_date
				+'&end_date='+end_date
				+'&pageNum='+pageNum
				+'&account='+account
				+'&product='+product
		...
		$('#page2310_div02').load('/sales_management/status_sales/search_status_sales_page?start_date='+start_date
				+'&end_date='+end_date
				+'&pageNum='+pageNum
				+'&account='+account
				+'&product='+product
