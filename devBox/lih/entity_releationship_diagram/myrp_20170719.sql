...
ALTER TABLE STATE DROP COLUMN DEPT_NAME;
ALTER TABLE STATE DROP COLUMN ACCESS_ROLE;
...
-- 관리자 계정 생성 코드
INSERT INTO DEPARTMENT(DEPT_ID,DEPT_NAME,ACCESS_ROLE)
VALUES(1000,'관리자','ADMIN');
INSERT INTO EMPLOYEE(EMPLOYEE_ID,EMPLOYEE_NAME,DEPT_ID,HR_CODE_GROUP_RANK,RANK_CODE,RESIDENCE_REG_NO)
VALUES(1001,'관리자',1000,2,500,'8011111111111');
INSERT INTO EMPLOYEE_INFO(EMPLOYEE_ID,HOURLY_WAGE)
VALUES(1001,10000);
COMMIT;