...
<body>
	<div class="row">
		<div class="col-xs-12">
			<div class="panel panel-primary">
				...
				<div class="panel-body" id="page3110_div01" style="padding-bottom: 0px; margin-bottom: 0px;" >
						...
						<form class="form-inline-block" action="#" name="purchase_list_form" method="get">
				            ...
				            <center>
					            <div class="btn-group btn-group-justified" role="group" aria-label="...">
									...
									<div class="btn-group" role="group">
										<input type="button" name="btn_reg_purchasel" class="btn btn-primary " value="구매등록" 	id="list_btn_reg">
									</div>
	...
	$('#list_btn_reg').click(function(){
		$('#page3110_page').slideUp();	// 페이징
		$('#page3110_table').slideDown();
		$('#page3110_table').load("/purchase_management/input_purchase/reg_purchase");
		return false;
	});
